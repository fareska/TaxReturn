        ...
        return (
            ...
            <header className="site-banner">
              <div id="mainContainer" className="container" >
                <h1>استرجاع ضريبة دخل مش رح يوجع راسك بعد اليوم!!</h1>
                <div className="row align-items-center justify-content-center">
                  ...
                  <figure className="col-md-4">
                    ...
                    <img src="https://topbrokers.com/files/2018.10/15406819459994.jpg" alt="Image" /> */}
                  </figure>
                </div>
              </div>
            </header>
            ...
            <div className="section">
              <div className="container">
                <div className="row text-center">
                  <div className="col-xl-4 section-block">
                    {/* <img className="width200" src="./images/one" alt="Image" /> */}
                    <div id="oneImg" className="whyUs"></div>
                ...
                <div className="col-xl-4 section-block">
                  ...
                  <div id="pay" className="whyUs"></div>
                ...
                <div className="col-xl-4 section-block">
                  {/* <img className="width200" src="" alt="Image" /> */}
                  <div id="survey" className="whyUs"></div>
            ...
            <div id="nums" className="section bg-light ">
              <div className="conatiner">
                ...
                <div className="justify-content-center">
                  <div>
                    <div>
                      ...
                      <button id="footerBtn">לבדיקה חינם</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <button id="fixedBtn" type="button" class="btn btn-cta btn-secondary btn--floating">לבדיקה חינם</button>
            </div>
